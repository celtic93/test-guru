...
tests = Test.create([{ title: 'Ruby Basic', category_id: 1 },
...
questions = Question.create([{ body: 'Ruby Basic question', test_id: 1 },
...
answers = Answer.create([{ body: 'Ruby Basic answer', question_id: 1 },
...
started_tests = StartedTest.create([{user_id: 1, test_id: 2, test_started: true},
